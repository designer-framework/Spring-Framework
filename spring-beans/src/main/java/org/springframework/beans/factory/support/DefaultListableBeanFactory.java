...
public class DefaultListableBeanFactory extends AbstractAutowireCapableBeanFactory
	...
	/**
	 *  {@link this#doGetBeanNamesForType(ResolvableType, boolean, boolean)}
	 * @return
	 */
	@Override
	...
	/**
	 * {@link this#isTypeMatch(String, ResolvableType)}
	 * @param type
	...
	/**
	 * 将bean定义放入beanDefinitionMap,第一次实例化时会从该集合查找
	...
	public Object doResolveDependency(DependencyDescriptor descriptor, @Nullable String beanName,
		...
		try {
			...
			if (instanceCandidate instanceof Class) {
				//被注入的是类, 则尝试从工厂获取 beanFactory.getBean(beanName);
